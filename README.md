...
`cobalt_v10.py` is the third rewrite (and current version) of the bot to comply with the introduction of API Keys in Cobalt v10. <br/><br/>
I am currently only maintaining the file `cobalt_v10.py`. <br/><br/>
